...
<%--                    <i class="orange ace-icon fa fa-location-arrow bigger-130">--%>
<%--                    </i>Add--%>
<%--                </button>--%>
<%--            </div>--%>
<%--            <div class="col-xs-12">--%>
...
<%--                <c:forEach var="list" items="${CSKHList}">--%>
<%--                    <tbody>--%>
<%--                    <tr>--%>
<%--                        <td>${list.createdDate}</td>--%>
<%--                        <td>${list.createdBy}</td>--%>
<%--                        <td>${list.modifiedDate.toString()}</td>--%>
...
<%--                <c:forEach var="list" items="${DDXList}">--%>
<%--            <div class="col-xs-12">--%>
<%--                    <table class="table table striped table-bordered table-nover">--%>
<%--                        <thead>--%>
<%--                        <tr>--%>
...
<%--&lt;%&ndash;                        <c:if test="${item.key=='DDX'}">&ndash;%&gt;--%>
<%--&lt;%&ndash;                        <c:forEach var="list" items="${DDXList}">&ndash;%&gt;--%>
<%--                        <tbody>--%>
<%--                        <tr>--%>
